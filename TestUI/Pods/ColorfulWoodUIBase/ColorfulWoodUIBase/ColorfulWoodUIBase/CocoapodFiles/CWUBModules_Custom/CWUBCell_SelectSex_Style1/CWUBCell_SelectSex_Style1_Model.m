...
+ (CWUBCell_SelectSex_Style1_Model*)tester_dataWithArray:(NSMutableArray*)array{
    ...
    model18.m_title_left = [[CWUBTextInfo alloc] initWithText:@"性别" font:[UIFont fontWithName:@"PingFangSC-Regular" size:16] color:CWUBDefineCreate_ColorRGB(0x333333)];
    ...
    model18.m_title_woman.m_lblCanClick = YES;
    model18.m_title_man.m_lblCanClick = YES;
    ...
    model18.m_cantEnabled = NO;
    model18.m_bottomLineInfo.m_color = CWUBDefineCreate_Color(233, 235, 239, 1);
    model18.m_bottomLineInfo.m_margin_right = 0.01;
