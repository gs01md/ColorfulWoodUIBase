//
//  UIImage+ColorfulWoodAddtional.m
...
@implementation UIImage (ColorfulWoodAddtional)
...
+ (UIImage *)imageWithHexString:(NSString *)color alpha:(CGFloat)alpha  size:(CGSize)size {
    return [UIImage imageWithColor:[UIImage colorWithHexString:color alpha:alpha] size:size];
}

+ (UIImage *)imageWithHexString:(NSString *)color size:(CGSize)size {
    return [UIImage imageWithColor:[UIImage colorWithHexString:color] size:size];
}
