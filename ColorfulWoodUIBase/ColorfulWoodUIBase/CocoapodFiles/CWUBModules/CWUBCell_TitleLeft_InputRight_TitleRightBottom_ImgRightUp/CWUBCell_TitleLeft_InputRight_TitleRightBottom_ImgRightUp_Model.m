...
@implementation CWUBCell_TitleLeft_InputRight_TitleRightBottom_ImgRightUp_Model

- (instancetype) init{

    if (self = [super init]) {
        self.m_typeName = @"CWUBCell_TitleLeft_InputRight_TitleRightBottom_ImgRightUp";
    }
...
+(CWUBCell_TitleLeft_InputRight_TitleRightBottom_ImgRightUp_Model *)tester_dataWithArray:(NSMutableArray *)data{

    CWUBCell_TitleLeft_InputRight_TitleRightBottom_ImgRightUp_Model * model14 = [CWUBCell_TitleLeft_InputRight_TitleRightBottom_ImgRightUp_Model new];
