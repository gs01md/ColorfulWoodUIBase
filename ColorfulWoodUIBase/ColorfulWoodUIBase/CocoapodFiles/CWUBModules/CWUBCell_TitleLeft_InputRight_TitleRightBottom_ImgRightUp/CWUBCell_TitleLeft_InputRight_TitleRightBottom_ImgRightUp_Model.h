//
//  CWUBCell_TitleLeft_InputRight_TitleRightBottom_ImgRight_Model.h
//  ColorfulWoodUIBase
//
...
@interface CWUBCell_TitleLeft_InputRight_TitleRightBottom_ImgRightUp_Model : CWUBModelBase
