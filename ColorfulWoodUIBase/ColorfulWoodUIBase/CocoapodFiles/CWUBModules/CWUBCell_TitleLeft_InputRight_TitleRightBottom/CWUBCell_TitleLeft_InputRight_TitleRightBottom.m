//
//  CWUBCell_TitleLeft_InputRight_TitleRightBottom.m
//  ColorfulWoodUIBase
//
...
@implementation CWUBCell_TitleLeft_InputRight_TitleRightBottom

- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier model:(CWUBCell_TitleLeft_InputRight_TitleRightBottom_Model*)model{
...
-(CWUBCell_TitleLeft_InputRight_TitleRightBottom_Model*) m_model{

    if (!_m_model) {
        _m_model = [CWUBCell_TitleLeft_InputRight_TitleRightBottom_Model new];
    }
