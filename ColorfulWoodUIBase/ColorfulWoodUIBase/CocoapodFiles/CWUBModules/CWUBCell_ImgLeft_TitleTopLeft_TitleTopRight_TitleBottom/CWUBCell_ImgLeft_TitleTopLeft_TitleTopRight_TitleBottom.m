//
//  CWUBCell_ImgLeft_TitleTopLeft_TitleTopRight_TitleBottom.m
//  ColorfulWoodUIBase
//
...
@interface CWUBCell_ImgLeft_TitleTopLeft_TitleTopRight_TitleBottom()
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier model:(CWUBCell_ImgLeft_TitleTopLeft_TitleTopRight_TitleBottom_Model*)model{
...
- (id)initWithModel:(CWUBCell_ImgLeft_TitleTopLeft_TitleTopRight_TitleBottom_Model*)model{
...
- (void)fun_commonInitWithModel:(CWUBCell_ImgLeft_TitleTopLeft_TitleTopRight_TitleBottom_Model*)model{

    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(notification_clearImg) name:CWUB_NOTIFICATION_CWUBCell_ImgLeft_TitleTopLeft_TitleTopRight_TitleBottom object:nil];
...
- (void)func_updateConsrtains{
    ...
    [_m_lbl_rightTopRight mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self).offset(-self.m_model.m_title_rightTopRight.m_margin_right);
...
-(CWUBCell_ImgLeft_TitleTopLeft_TitleTopRight_TitleBottom_Model*) m_model{

    if (!_m_model) {
        _m_model = [CWUBCell_ImgLeft_TitleTopLeft_TitleTopRight_TitleBottom_Model new];
    }
...
-(CWUBImageViewWithModel *)m_img_left{
    ...
    if(!_m_img_left){
        ...
        [_m_img_left setUserInteractionEnabled:NO];
